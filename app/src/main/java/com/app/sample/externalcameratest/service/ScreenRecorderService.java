package com.app.sample.externalcameratest.service;
...
import com.app.sample.externalcameratest.MainActivity;
import com.app.sample.externalcameratest.R;
import com.app.sample.externalcameratest.media.MediaAudioEncoder;
import com.app.sample.externalcameratest.media.MediaEncoder;
import com.app.sample.externalcameratest.media.MediaMuxerWrapper;
import com.app.sample.externalcameratest.media.MediaScreenEncoder;
    ...
    private void startScreenRecord(final Intent intent) {
        ...
        synchronized (sSync) {
            if (sMuxer == null) {
                ...
                EventBus.getDefault().postSticky(mediaProjection);
